...
local numfaves = 0
local AvatarX = 0
local AvatarY = 1/SCREEN_HEIGHT +20
...
t[#t + 1] = Def.ActorFrame {
	...
	UIElements.TextToolTip(1, 1, "Common Normal") .. {
		...
		InitCommand = function(self)
			...
			self:zoom(0.55)
			self:maxwidth(capWideScale(360,400))
			self:maxheight(22)
	...
	UIElements.TextToolTip(1, 1, "Common Normal") .. {
		Name = "Version",
		InitCommand = function(self)
			self:xy(SCREEN_WIDTH - 3, AvatarY + 426):halign(1):zoom(0.42):diffuse(ButtonColor)
		end,
		BeginCommand = function(self)
			self:queuecommand("Set")
		end,
	...
	LoadFont("Common Normal") .. {
		InitCommand = function(self)
			self:xy(SCREEN_WIDTH - 3, AvatarY + 435):halign(1):zoom(0.35):diffuse(nonButtonColor)
		end,
		BeginCommand = function(self)
			self:queuecommand("Set")
		end,
...
t[#t + 1] = Def.ActorFrame {
	...
	LoadFont("Common Normal") .. {
		Name = "CurrentTime",
		InitCommand = function(self)
			self:xy(SCREEN_WIDTH - 3, SCREEN_BOTTOM - 993.5):halign(1):valign(1):zoom(0.45)
		end
	},
